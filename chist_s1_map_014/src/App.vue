  ...
  <div id="app">
    ...
    >
      <div class="title_bar purpleGradient" :style="{'height':titleH +'px'}">
        <span>南宋海外貿易路線圖 (1127-1279 年)</span>
    ...
    >
      <div slot="modalCont">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24783896.90080541!2d88.20884189593025!3d38.69419131197747!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x344bb629439aaa99%3A0xa7bfd183824de83a!2z5Lit5ZyL5rWZ5rGf55yB5p2t5bee5biC!5e0!3m2!1szh-TW!2shk!4v1575947399030!5m2!1szh-TW!2shk"
  ...
  data() {
    return {
      ...
      list: [
        ...
        {
          ico: require("../static/img/icon/location.png"),
          text: "重要地點",
          show: false
        },
        {
          ico: require("../static/img/icon/route.png"),
          text: "海外貿易路線",
          show: false
        },
        {
  ...
  methods: {
    ...
    createMap() {
      ...
      let list = [
        ...
        { name: "myCanvasStatic3", zindex: 3 },
        { name: "myCanvasStatic4", zindex: 2 },
        { name: "myCanvasStatic5", zindex: 2 },
        { name: "myCanvasStatic6", zindex: 3 },
        { name: "myCanvasStatic7", zindex: 3 },
        { name: "myCanvasStatic8", zindex: 3 },
        { name: "myCanvasStatic9", zindex: 2 },
        { name: "myCanvasStatic10", zindex: 2 },
      ...
      this.m01.src = require("../static/img/vo/Map014-1.mp3");
      this.m02.src = require("../static/img/vo/Map014-2.mp3");
      this.m03.src = require("../static/img/vo/Map014-3.mp3");
      this.license.src = require("../static/img/vo/wave.mp3");
      this.license.loop='loop'
      this.license.volume =0.3
      // Variable init

      var imageMapDetail = new Image();
      var imageMapDetail1 = new Image();
      ...
      imageMapDetail1.src = require("../static/img/mapDetail1.png");
      imageCapital.src = require("../static/img/capital.png");
      city1.src = require("../static/img/location1.png");
      city2.src = require("../static/img/location2.png");
      city3.src = require("../static/img/location3.png");
      city4.src = require("../static/img/location4.png");
      city5.src = require("../static/img/location5.png");
      route.src = require("../static/img/route.png");
      imageHorse.src = require("../static/img/trader.png");

      this.insterCanvas(imageMapDetail, "myCanvasStatic1", true);
      this.insterCanvas(imageMapDetail1, "myCanvasStatic2", true);
      this.insterCanvas(imageCapital, "myCanvasStatic3", false);
      this.insterCanvas(city1, "myCanvasStatic4", false);
      this.insterCanvas(city2, "myCanvasStatic5", false);
      this.insterCanvas(city3, "myCanvasStatic6", false);
      this.insterCanvas(city4, "myCanvasStatic7", false);
      this.insterCanvas(city5, "myCanvasStatic8", false);

      // this.insterCanvas(nation, "myCanvasStatic9", false);
      this.insterCanvas(route, "myCanvasStatic10", false);


      imageHorse.onload = () => {
        var translate = [[1270,-74],[1116,31],[1142,161]]
        var scale = [1, 1,0];
        var dur = [20, 10,20 ];
        var sharpPoint = ''
        ...
        var translate = [[1110,74],[920, 217], [834, 436],[922,758]];
        var scale = [1, 1,1,0];
        var dur = [30,20, 20,20];
        var sharpPoint = ''
        ...
        var translate = [[820,576],[622,406],[396,426],[288,220],[128, 126], [80, 132],[0, 224]];
        var scale = [1, 1,1,1,1,1,0];
        var dur = [20, 20, 20,20,10,10,10];
        var sharpPoint = ''
