...
var RangeSlider = { render: function render() {
  ...
  methods: {
    ...
    drag: function drag(event, offset) {
      var offsetHeight = this.$refs.inner.offsetHeight;
      var offsetWidth = this.$refs.inner.offsetWidth;
      // console.log(offsetHeight,offsetWidth,offset.top,offset.left)
      if(this.ori == 90){        
        this.actualValue = this.round(this.valueFromBounds(offsetWidth-offset.top, offsetWidth));
      }else{
