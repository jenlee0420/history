  ...
  <div id="app">
    ...
    <div v-show="!load" id="main_container" :style="mainBoxStyle">
      <div class="title_bar purpleGradient" :style="{ height: titleH + 'px' }">
        <span>明代長城沿線九邊及遼東邊牆位置圖 (1398-1505 年)</span>
      ...
      <div class="main_box">
        <div id="map_container" class="modal_content" ref="map_container" :style="{ width: canvasW + 'px', height: canvasH + 'px' }">
          <div class="mapBackground" id="canvasInnerDiv" ref="canvasInnerDiv">
            ...
            <imageview :canvasW="baseWidth" :canvasH="baseHeight" :imgsrc="'gate01.png'" :static="control.gate01.show" :zindex="2" @update="updateImg"></imageview>
            <imageview :canvasW="baseWidth" :canvasH="baseHeight" :imgsrc="'gate02.png'" :static="control.gate02.show" :zindex="2" @update="updateImg"></imageview>
            <imageview :canvasW="baseWidth" :canvasH="baseHeight" :imgsrc="'gate03.png'" :static="control.gate03.show" :zindex="2" @update="updateImg"></imageview>
      ...
      <div slot="modalCont">
        <div>
          <div class="question">
            <div class="flex">
              <em class="mr5">1.</em>
              <em>根據地圖所示<span class="dot">，</span>以下哪一個關口是明朝長城的西部終點？</em>
            </div>
            <div>
          ...
          <div class="question">
            <div class="flex">
              <em class="mr5">2.</em>
              <em>根據地圖所示<span class="dot">，</span>以下哪一個「九邊重鎮」位於河套地區以外？</em>
            </div>
            <div>
    ...
    <modal class="" :style="AppStyle" :dragable="!isApp" :headTitle="list[7].text" :hideFooter="true" v-if="mapPop" @cancel-event="
                  mapPop = false;
                  list[7].show = false;
                ">
      <div slot="modalCont">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31556713.15866778!2d85.16666531810682!3d39.97618497346462
!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35f05296e7142cb9%3A0xb9625620af0fa98a!2z5Lit5ZyL5YyX5Lqs5biC!5e0!3m2
!1szh-TW!2shk!4v1608783555849!5m2!1szh-TW!2shk" :width="(isApp?docWidth:bodytWidth)/1.8" :height="(isApp?docHeight:bodyHeight)/1.8" frameborder="0" style="border:0;" allowfullscreen></iframe>
      </div>
    </modal>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        imgCount: 0,
        imgTotal: 11,
        questionItem: ["A. 山海關  ", "B. 嘉峪關 ", "C. 居庸關  "],
        rightans: 1,
        showWrong: 0,
        currAns: null,
        questionItem2: [
        ...
        list: [{
          ...
          {
            ico: require("../static/img/icon/nomad_049_icon.png"),
            text: "遊牧民族 ",
            show: false
          },
          {
            ico: require("../static/img/icon/GreatWall_049.png"),
            text: "長城 ",
            show: false
          },
          {
          ...
          {
            ico: require("../static/img/icon/border_049_icon.png"),
            text: "疆界",
            show: false
          },
    ...
    methods: {
      ...
      showCanvas(index) {
        ...
        switch (index) {
          ...
          case 2:
            ...
            if (swip) {
              if (!this.noVoice && !this.isShowall) {
                ...
                this.timer1[0] = setTimeout(() => {
                   this.sharpCity(this.control.gate02, swip)
                }, 21000)
                this.timer1[1] = setTimeout(() => {
                   this.sharpCity(this.control.gate03, swip)
                }, 45000)
            ...
            this.sharpCity(this.control.gate01, swip)
            if(!swip){
              this.sharpCity(this.control.gate02, swip)
              this.sharpCity(this.control.gate03, swip)
            }
      ...
      conflict() {
        ...
        if (swip4) {
          this.control.gate01.show=true
          this.control.gate02.show=true
          this.control.gate03.show=true
        }
        if(!swip2 && !swip4){
           this.control.gate01.show=false
          this.control.gate02.show=false
          this.control.gate03.show=false
        }
      },
      oriChange() {
      ...
      createMap() {
        ...
        this.m01.src = require("../static/img/vo/MAP49-1.mp3");
        this.m02.src = require("../static/img/vo/MAP49-2.mp3");
        this.m03.src = require("../static/img/vo/MAP49-3.mp3");
        this.m04.src = require("../static/img/vo/MAP49-4.mp3");
        this.m05.src = require("../static/img/vo/MAP49-5.mp3");
