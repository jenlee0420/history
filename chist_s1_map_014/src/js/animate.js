const animate = {
    ...
    showCity(flag){
     if(flag){
       this.timeArr.time1 = setTimeout(()=>{
        this.canvasObj['myCanvasStatic4'] .style.visibility = 'visible'
       },16800)
       this.timeArr.time2 = setTimeout(()=>{
        this.canvasObj['myCanvasStatic5'] .style.visibility = 'visible'
       },18500)
       this.timeArr.time3 = setTimeout(()=>{
        this.canvasObj['myCanvasStatic6'] .style.visibility = 'visible'
       },19100)
       this.timeArr.time4 = setTimeout(()=>{
        this.canvasObj['myCanvasStatic7'] .style.visibility = 'visible'
       },20000)
       this.timeArr.time5 = setTimeout(()=>{
        this.canvasObj['myCanvasStatic8'] .style.visibility = 'visible'
       },21000)
     }else{
      clearTimeout(this.timeArr.time1)
      clearTimeout(this.timeArr.time2)
      clearTimeout(this.timeArr.time3)
      clearTimeout(this.timeArr.time4)
      clearTimeout(this.timeArr.time5)
      this.canvasObj['myCanvasStatic4'] .style.visibility = 'hidden'
      this.canvasObj['myCanvasStatic5'] .style.visibility = 'hidden'
      this.canvasObj['myCanvasStatic6'] .style.visibility = 'hidden'
      this.canvasObj['myCanvasStatic7'] .style.visibility = 'hidden'
      this.canvasObj['myCanvasStatic8'] .style.visibility = 'hidden'
     }
    },
    drawRedPath(flag) {
