<template>
  <div id="app">
      ...
      <div class="main_box">
        <div id="map_container" class="modal_content" ref="map_container" :style="{ width: canvasW + 'px', height: canvasH + 'px' }">
          <div class="mapBackground" id="canvasInnerDiv" ref="canvasInnerDiv">
            ...
            <imageview :canvasW="baseWidth" :canvasH="baseHeight" :imgsrc="'canal.png'" :static="control.canal.show" :zindex="2" @update="updateImg"></imageview>
      ...
      <div slot="modalCont">
        <div>
          <div class="question">
            <div class="flex">
              <em class="mr5">1.</em>
              <em>根據地圖所示<span class="dot">，</span>以下哪一個並不是直接由汴河所連接的水系？</em>
            </div>
            <div>
          ...
          <div class="question question3">
            <div class="flex">
              <em class="mr5">2.</em>
              <em>根據地圖所示<span class="dot">，</span>以下哪項關於汴京位置的描述是正確的？</em>
            </div>
            <div>
    ...
    <modal class="" :style="AppStyle" :dragable="!isApp" :headTitle="list[4].text" :hideFooter="true" v-if="mapPop" @cancel-event="
                ...
                ">
      <div slot="modalCont">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31457797.784411725!2d80.88715147621804!3d35.9690934090060
6!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35d0992038b6f237%3A0x6defd67fbb81498c!2z5Lit5ZyL5rKz5Y2X55yB6ZaL5b
CB5biC!5e0!3m2!1szh-TW!2shk!4v1605773793955!5m2!1szh-TW!2shk" :width="(isApp?docWidth:bodytWidth)/1.8" :height="(isApp?docHeight:bodyHeight)/1.8" frameborder="0" style="border:0;" allowfullscreen></iframe>
      </div>
    </modal>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [{
          ...
          {
            ico: require("../static/img/icon/canal_043_icon.png"),
            text: "運河",
            show: false
          },
          {
            ico: require("../static/img/icon/border_043_icon.png"),
            text: "疆界 ",
            show: false
          },
    ...
    methods: {
      ...
      showCanvas(index) {
        ...
        switch (index) {
          ...
          case 1:
            ...
            break;
          case 2:
            this.sharpCity(this.control.canal, swip)
      ...
      conflict() {
        let swip3 = this.list[2].show;
        let swip1 = this.list[0].show;
        let swip2 = this.list[1].show;
        this.control.capital.show = swip1
        this.control.main_city = swip2
        if (swip3) {
      ...
      createMap() {
        ...
        this.m01.src = require("../static/img/vo/Chist_s2_map_043_01.mp3");
        this.m02.src = require("../static/img/vo/Chist_s2_map_043_02.mp3");
        this.m03.src = require("../static/img/vo/Chist_s2_map_043_03.mp3");
        this.m04.src = require("../static/img/vo/Chist_s2_map_043_04.mp3");
