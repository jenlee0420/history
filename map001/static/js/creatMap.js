...
var imageMap, imageborder ,imageMapDetail, imagedongdu, imageRiver2, imageRiver3, imageRiver4, imageRiver5, imagerice;
...
m01.src = '/static/img/vo/Map002-1.mp3'
...
imageGate.onload = function() {
    ...
    contextStatic2.drawImage(imageGate, 0, 0, baseWidth, baseHeight);
}
...
function createMap(controlArray, scale) {
    ...
    if (!sameChecking) {
        ...
        console.log(contextBackground)
        contextBackground.drawImage(imageMap, 0, 0, boundary, boundaryH);
        contextBackground.drawImage(imageborder, 0, 0, boundary, boundaryH);
    }
    ...
    */
    ...
    document.getElementById('canvasInnerDiv').append(divTag)
    // return $(divTag);
}
...
function drawHousePromise() {
    ...
    canvasAnimHorse.style.visibility = 'visible'
    contextAnimHorse.drawImage(imageHorse, horseObject1.position.points[0][0], horseObject1.position.points[0][1], horseObject1.width * 0.45, horseObject1.height * 0.45);
...
function drawHorse(object, isInvert, endfun, contextS) {
    ...
    if (object.position.currPoint + 1 < object.position.totalPoint) {
        ...
        contextS.drawImage(imageHorse, position[0], position[1], object.width * scale * 0.45, object.height * scale * 0.45);
        contextS.restore();
