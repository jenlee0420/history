        ...
        <div>
          <div class="question question2">
            <div class="flex">
              <em class="mr5">1.</em>
              <em>以下哪一個
                <span class="underline">不是</span>隋煬帝下令建設運河的原因？
              </em>
            </div>
            <div>
              <span
...
export default {
  ...
  data() {
    return {
      ...
      showWrong: 0,
      currAns: null,
      questionItem2: ["A. 永濟渠", "B. 廣通渠 ", "C. 江南河", "D. 山陽瀆"],
      rightans2: 2,
      showWrong2: 0,
      currAns2: null,
      data: [],
  ...
  methods: {
    ...
    createMap() {
      ...
      Object.keys(this.canvasImagesObj).forEach(element => {
        ...
        this.canvasObjTemp[element+'temp'].getContext("2d").drawImage(this.canvasImagesObj[element],0,0,this.baseWidth,
          this.baseHeight)
      });
      ...
      this.insterCanvas(this.route1,'route1/xianlu1a0090.png','tempCanvas',false)
      this.insterCanvas(this.route2,'route2/xianlu2b0050.png','tempCanvas2',false)
      ...
      this.insterCanvas2(imageHorse, "ship.png", () => {
        ...
        dur = [7, 10, 7];
        sharpPoint = [0, 0, 1];
        this.horseObject5 = this.initHorseObject(
          translate,
          scale,
          dur,
          sharpPoint,
...
// console.log(this.canvasObjTemp['canvasAnimHorsetemp'])
this.canvasObjTemp['canvasAnimHorsetemp'].width=820
this.canvasObjTemp['canvasAnimHorsetemp'].height=360

        this.canvasObjTemp['canvasAnimHorsetemp'].getContext("2d").drawImage(imageHorse,0,0,820,360)
      });
