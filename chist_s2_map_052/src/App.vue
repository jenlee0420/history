<template>
  <div id="app">
      ...
      <div slot="modalCont">
        <div>
          <div class="question question3">
            <div class="flex">
              <em class="mr5">1.</em>
              <em>根據地圖所示<span class="dot">，</span>以下哪項關於民變進軍路線的描述是錯誤的？</em>
            </div>
            <div>
              <span
                class="item"
          ...
          <div class="question question3">
            <div class="flex">
              <em class="mr5">2.</em>
              <em>根據地圖所示<span class="dot">，</span>以下哪項關於民變影響的描述是正確的？</em>
            </div>
            <div>
              <span
                class="item"
    ...
    >
      <div slot="modalCont">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d26764923.30551607!2d88.20536378657613!3d39.38275608246977!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35f05296e7142cb9%3A0xb9625620af0fa98a!2z5Lit5ZyL5YyX5Lqs5biC!5e0!3m2!1szh-TW!2shk!4v1608782664818!5m2!1szh-TW!2shk"
...
export default {
  ...
  data() {
    return {
      ...
      imgCount: 0,
      imgTotal: 15,
      questionItem: ["A. 李<span class='dot'>、</span>張部隊聯手攻陷北京", "B. 李自成的起事地點位於黃河流域 ", "C. 張獻忠自東向西進軍"],
      rightans: 0,
      showWrong: 0,
      currAns: null,
      questionItem2: ["A. 李自成邀清兵入關", "B. 明朝未有因此滅亡 ", "C. 四川一帶被民變部隊佔領"],
      rightans2: 2,
      showWrong2: 0,
      currAns2: null,
      data: [],
...
{
          ico: require("../static/img/icon/route1_icon.png"),
          text: "李自成進軍路線 ",
          show: false
        },
        {
          ico: require("../static/img/icon/route2_icon.png"),
          text: "張獻忠進軍路線 ",
          show: false
        },
        {
  ...
  methods: {
    ...
    showCanvas(index) {
      ...
      switch (index) {
        ...
        case 1:
          ...
          this.sharpCity(this.control.gate, swip);
          if (!swip) {
            this.control.gate.show = true;
          }
          break;
        case 2:
          if (swip && !this.noVoice) {
        ...
        case 3:
          ...
          this.control.mountain1 = swip;
          this.control.mountain2 = swip;
          break;
        case 4:
          if (swip && !this.noVoice) {
    ...
    conflict() {
      ...
      let swip9 = this.list[9].show;
      this.control.main_city1 = swip2;
      this.control.main_city2 = swip2;
      this.control.main_city3 = swip2;
      this.control.mountain1 = swip3;
      this.control.battlefield = this.list[4].show;
      if (swip8) {
        this.control.main_city1 = true;
        this.control.mountain1 = true;
        this.control.battlefield =true
      }
      if (swip9) {
        this.control.main_city2 = true;
        this.control.mountain2 = true;
      }
    },
    oriChange() {
    ...
    createMap() {
      ...
      this.m01.src = require("../static/img/vo/MAP 52-1.mp3");
      this.m02.src = require("../static/img/vo/MAP 52-2.mp3");
      this.m03.src = require("../static/img/vo/MAP 52-3.mp3");
      this.m04.src = require("../static/img/vo/MAP 52-5.mp3");
      this.m05.src = require("../static/img/vo/MAP 52-7.mp3");
      this.m06.src = require("../static/img/vo/MAP 52-8.mp3");
      this.m07.src = require("../static/img/vo/MAP 52-9.mp3");
      this.m08.src = require("../static/img/vo/MAP 52-10.mp3");

      var imageHorse = new Image();
      var imageHorse2 = new Image();
      this.insterCanvas2(imageHorse, "Mingsolider_052.png", () => {
        var translate = [[747.1, 440], [545.1, 468], [654.1, 373],[758.1,207],[888.1,187],[1026.2,237]];
        var scale = [1, 1, 1,1,1,0];
        var dur = [30, 30, 30,30,20,5];
        ...
        var translate = [[758.1,187], [806.2, 80],[864.2,10],[1026.2,237]];
        var scale = [1, 1, 1,0];
        var dur = [20, 15, 15,5];
