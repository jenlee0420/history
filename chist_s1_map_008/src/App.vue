      ...
      <div class="main_box">
        ...
        >
          <div class="mapBackground" id="canvasInnerDiv" ref="canvasInnerDiv">
            ...
            <imageview :imgsrc="'huihe-min.png'" :static="control.huihe" :zindex="4" @update="updateImg"></imageview>
            <imageview :imgsrc="'nanzhao-min.png'" :static="control.nanzhao" :zindex="2" @update="updateImg"></imageview>
            <imageview :imgsrc="'tubo-min.png'" :static="control.tubo" :zindex="3" @update="updateImg"></imageview>
...
export default {
  ...
  methods: {
    ...
    createMap() {
      ...
      imagedust.src = require("../static/img/dust1-min.png");
