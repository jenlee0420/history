                    ...
                    $("<div/>", {
                        ...
                        $("<div/>", {
                            ...
                            $("<div/>").addClass("sample blueButton action").data("action", "0").append(
                                $("<span />").append($("<img />", {
                                    "src": "img/icon/shoudu.png"
                                }).addClass("icon fix_height"), "首都")
                            ),
                            $("<div/>").addClass("sample blueButton action").data("action", "1").append(
                                $("<span />").append($("<img />", {
                                    "src": "img/icon/guancang.png"
                                }).addClass("icon fix_height"), "官倉")
                            ),
                            $("<div/>").addClass("sample blueButton action").data("action", "2").append(
                                $("<span />").append($("<img />", {
                                    "src": "img/icon/jiangjiexian.png"
                                }).addClass("icon fix_height"), "疆界")
                            ),
                            
                            $("<div />").addClass("sample blueButton action googlemap").data({
                                "action": "8",
                                "path": "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d845158.7150065893!2d108.8816973!3d34.161658!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x366379e922ac17b9%3A0x85d466fda794582e!2z5Lit5ZyL6Zmd6KW_55yB6KW_5a6J5biC!5e0!3m2!1szh-TW!2shk!4v1572421815894!5m2!1szh-TW!2shk",
                                "title": "大興（今西安市）"
                            }).append(
                                $("<span />").append($("<img />", {
                                    "src": "img/icon/shoudu.png"
