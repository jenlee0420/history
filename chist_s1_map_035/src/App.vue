      ...
      <div class="main_box">
        <div id="map_container" class="modal_content" ref="map_container" :style="{ width: canvasW + 'px', height: canvasH + 'px' }">
          <div class="mapBackground" id="canvasInnerDiv" ref="canvasInnerDiv">
            ...
            <!-- <imageview :imgsrc="'border.png'" :static="true" :zindex="3" @update="updateImg"></imageview> -->
            <imageview :imgsrc="'capital.png'" :static="control.capital.show" :zindex="2" @update="updateImg"></imageview>
            <imageview :imgsrc="'capital1.png'" :static="control.capital1.show" :zindex="2" @update="updateImg"></imageview>
      ...
      <div slot="modalCont">
        <div>
          <div class="question question2">
            <div class="flex">
              <em class="mr5">1.</em><em> 根據地圖所示<span class="dot">，</span>以下哪項關於北魏新都的描述是<span class="underline">不正確</span>的？</em>
            </div>
            <div>
        ...
        >
          <div slot="modalCont">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d25601913.36228759!2d85.14086073145123!3d38.436073710264345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35e2d387156011f5%3A0x96198820001f0273!2z5Lit5ZyL5bGx6KW_55yB5aSn5ZCM5biC!5e0!3m2!1szh-TW!2shk!4v1591580860791!5m2!1szh-TW!2shk"
  ...
  export default {
    ...
    data() {
      return {
        ...
        mapPop: false,
        list: [{
            ico: require("../static/img/icon/capital1_icon.png"),
            text: "前期首都",
            show: false
          },
          {
          ...
          {
            ico: require("../static/img/icon/border_035_icon.png"),
            text: "國界",
            show: false
          },
          {
            ico: require("../static/img/icon/route_035_icon.png"),
            text: "遷都路線",
            show: false
          },
          {
    ...
    methods: {
      ...
      showCanvas(index) {
        ...
        switch (index) {
          case 0:
            ...
            this.sharpCity(this.control.capital1, swip);
            break;
          case 1:
            if (swip && !this.noVoice) {
      ...
      conflict() {
        ...
        this.control.capital1.show = this.list[0].show;
        if (swip3) {
          this.control.capital.show = true
          this.control.capital1.show = true
        }
      },
      oriChange() {
        setTimeout(() => {
      ...
      createMap() {
        ...
        this.m01.src = require("../static/img/vo/chist_s1_map_035_1.mp3");
        this.m02.src = require("../static/img/vo/chist_s1_map_035_2.mp3");
        this.m03.src = require("../static/img/vo/chist_s1_map_035_3.mp3");
        this.m04.src = require("../static/img/vo/chist_s1_map_035_4.mp3");
        ...
        this.insterCanvas2(zhangqian, 'gharry_035.png', () => {
          var translate = [
            [880.2, 106],
            [876.9, 468.0],
            [934.950, 686]
