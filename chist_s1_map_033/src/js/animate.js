const animate = {
    ...
    drawCircle(){
      let context =this.contextObj['canvasImages']
      context.strokeStyle = "green";
      context.lineWidth=4
      context.beginPath();
      context.arc(605, 339, 41, 0, Math.PI*2, true);
      context.closePath();
      context.stroke()
      context.beginPath();
      context.arc(566, 538, 41, 0, Math.PI*2, true);
      context.closePath();
      context.stroke()
      context.beginPath();
      context.arc(732, 567, 41, 0, Math.PI*2, true);
      context.closePath();
      context.stroke()
    },
    ...
    imagesCanvas(){
      ...
      if(this.control.han1==true && this.imageObj.han){
        this.contextObj['canvasImages'].drawImage(this.imageObj.han,0,0,this.baseWidth,this.baseHeight);
      }
      if(this.control.wei1==true && this.imageObj.wei){
        this.contextObj['canvasImages'].drawImage(this.imageObj.wei,0,0,this.baseWidth,this.baseHeight);
      }
      if(this.control.zhao1==true && this.imageObj.zhao){
        this.contextObj['canvasImages'].drawImage(this.imageObj.zhao,0,0,this.baseWidth,this.baseHeight);
      }
      if(this.control.Circle){
        this.drawCircle()
      }
    }
}
