  ...
  <div id="app">
    ...
    <div id="main_container" :style="{'width':docWidth+'px','height':docHeight+'px','display':load?'none':'block'}">
      <div class="title_bar purpleGradient" :style="{'height':titleH +'px'}">
        <span>秦代交通和國防建設分佈圖 (公元前221-前206 年)</span>
    ...
    <modal class="" headTitle="問題" :hideFooter="true" v-if="popWindow" @cancel-event="popWindow=false;list[9].show=false">
      <div slot="modalCont">
        <div>
          <div class="question">
            <div class="flex">
              <em class="mr5">1.</em>
              <em>根據地圖所示<span class="dot">，</span>匈奴在北方構成威脅<span class="dot">，</span>以下哪項<font class="underline">不是</font>秦朝的應對措施？
                </em>
            </div>
            <div>
          ...
          <div class="question question2">
            <div>
              <em class="mr5">2.</em>根據地圖所示<span class="dot">，</span>以下哪項關於秦代建設的描述是正確的？
            </div>
            <div>
    ...
    <modal class="" :headTitle="list[8].text" :hideFooter="true" v-if="mapPop" @cancel-event="mapPop=false;list[8].show=false">
      <div slot="modalCont">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30707751.389084052!2d82.33944004533646!3d37.811026929297725!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3663847664f98611%3A0x4694b2f767ca6286!2z5Lit5ZyL6Zmd6KW_55yB5ZK46Zm95biC!5e0!3m2!1szh-TW!2shk!4v1594606402203!5m2!1szh-TW!2shk"
  ...
  export default {
    ...
    data() {
      return {
        ...
        noVoice: false,
        zoomObj: null,
        questionItem: ["A. 修築長城", "B. 開鑿鴻溝", "C. 開通直道"],
        rightans: 1,
        showWrong: 0,
        currAns: null,
        questionItem2: [
          "A. 長城西起臨洮<span class='dot'>，</span>東至遼東",
    ...
    methods: {
      ...
      checkPause(audioPlayer) {    
        if (audioPlayer.paused) {} else {
          audioPlayer.pause()
        }
      },
      muteMe() {
        this.checkPause(this.m01)
        this.checkPause(this.m02)
        this.checkPause(this.m03)
        this.checkPause(this.m04)
        this.checkPause(this.m05)
        this.checkPause(this.m06)
        this.checkPause(this.m07)
        // this.m01.pause();
        // this.m02.pause();
        // this.m03.pause();
        // this.m04.pause();
          ...
          case 6:
            if (swip) {
              if (this.noVoice) {
                ...
                this.m06.play();
                this.timerAni1 = setTimeout(() => {
                  this.control.canal1 = true;
                }, 5000);
                this.timerAni2 = setTimeout(() => {
                  this.control.canal2 = true;
                }, 14000);
              }
            }
            if (!swip) {
              clearTimeout(this.timerAni1);
              clearTimeout(this.timerAni2);
              this.control.canal1 = false;
              this.control.canal2 = false;
            }
            break;
          case 7:
            if (swip && !this.noVoice) {
      ...
      createMap() {
        ...
        let list = [{
            name: "myCanvasAnimRoad",
            zindex: 3
          },
          {
            name: "myCanvasAnimHorse",
            zindex: 5
          },
          {
            name: "canvasImages",
        ...
        // Variable init
        this.imageObj.canal1=new Image()
        this.imageObj.canal2=new Image()
        this.imageObj.route = new Image();
        this.imageObj.zhidao = new Image();
        this.imageObj.GreatWall = new Image();
        this.imageObj.border = new Image();
        this.insterCanvas(this.imageObj.canal1,'canal1.png','canvasImages',false)
        this.insterCanvas(this.imageObj.canal2,'canal2.png','canvasImages',false)
        this.insterCanvas(this.imageObj.route,'route.png','canvasImages',false)
        this.insterCanvas(this.imageObj.zhidao,'zhidao.png','canvasImages',false)
        this.insterCanvas(this.imageObj.GreatWall,'GreatWall.png','canvasImages',false)
