const animate = {
    ...
    horseAni1(flag) {
        let canvasAnimHorse = document.getElementById("canvasStatic1");
    ...
    horseAni2(flag) {
        let canvasAnimHorse = document.getElementById("canvasStatic2");
        let contextAnimHorse = canvasAnimHorse.getContext("2d");
        if (flag) {
            ...
            canvasAnimHorse.style.visibility = "visible";
            this.horseObject2.animating = true                
    ...
    horseAni3(flag) {
        let canvasAnimHorse = document.getElementById("canvasStatic3");
        let contextAnimHorse = canvasAnimHorse.getContext("2d");
        if (flag) {
            if (this.horseObject3.animated == true) {
                return;
            }
            canvasAnimHorse.style.visibility = "visible";
            this.horseObject3.animating = true                
            this.drawHorsesTimeout2 = setInterval(() => {
                this.canvasClear(canvasAnimHorse);
                this.drawSingleHorse(
                    this.horseObject3,
    ...
    dustAni(flag) {
        let canvasAnimHorse = document.getElementById("canvasStatic4");
        let contextAnimHorse = canvasAnimHorse.getContext("2d");
        if (flag) {
            ...
            canvasAnimHorse.style.visibility = "visible";
            this.horseObject4.animating = true                
    ...
    drawSingleHorse(object, contextS, imageHorse,x,y) {
        return new Promise((resolve, rej) => {
            contextS.save();
            var position = new Array();
            var scale;
