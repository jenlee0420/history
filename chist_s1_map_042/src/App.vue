<template>
  <div id="app">
      ...
      <div slot="modalCont">
        <div>
          <div class="question">
            <div class="flex">
              <em class="mr5">1.</em>
              <em>根據地圖所示<span class="dot">，</span>以下哪一種物產是北宋境內所缺乏的？</em>
            </div>
            <div>
    ...
    <modal class="" :style="AppStyle" :dragable="!isApp" :headTitle="list[8].text" :hideFooter="true" v-if="mapPop" @cancel-event="
                  mapPop = false;
                  list[8].show = false;
                ">
      <div slot="modalCont">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29968854.420779664!2d81.1353492394198!3d35.22685368013096
!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x360aa8ebade29601%3A0xdabd32137ae53d2b!2z5Lit5ZyL5bGx6KW_55yB5aSq5
Y6f5biC!5e0!3m2!1szh-TW!2shk!4v1605842735946!5m2!1szh-TW!2shk" :width="(isApp?docWidth:bodytWidth)/1.8" :height="(isApp?docHeight:bodyHeight)/1.8" frameborder="0" style="border:0;" allowfullscreen></iframe>
      </div>
    </modal>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [{
          ...
          {
            ico: require("../static/img/icon/border_042_icon.png"),
            text: "疆界",
            show: false
          },
          {
            ico: require("../static/img/icon/porcelain_icon.png"),
            text: "瓷器 ",
            show: false
          },
          {
            ico: require("../static/img/icon/textile_icon.png"),
            text: "紡織品 ",
            show: false
          },
          {
            ico: require("../static/img/icon/rice_icon.png"),
            text: "大米 ",
            show: false
          },
          {
            ico: require("../static/img/icon/wood_icon.png"),
            text: "木材",
            show: false
          },
          {
            ico: require("../static/img/icon/horse_icon.png"),
            text: "馬匹",
            show: false
          },
    ...
    methods: {
      ...
      createMap() {
        ...
        this.m01.src = require("../static/img/vo/Chist_s2_map_042_01.mp3");
        this.m02.src = require("../static/img/vo/Chist_s2_map_042_02.mp3");
        this.m03.src = require("../static/img/vo/Chist_s2_map_042_03.mp3");
        this.m04.src = require("../static/img/vo/Chist_s2_map_042_04.mp3");
        this.m05.src = require("../static/img/vo/Chist_s2_map_042_05.mp3");
        this.m06.src = require("../static/img/vo/Chist_s2_map_042_06.mp3");
        this.m07.src = require("../static/img/vo/Chist_s2_map_042_07.mp3");
        this.m08.src = require("../static/img/vo/Chist_s2_map_042_08.mp3");
        ...
        // });
        this.insterCanvas2(imageHorse, "horse01.png", () => {
          var translate = [[472, 268], [632.1, 400]];
          var scale = [1, 1];
          var dur = [30];
          var sharpPoint = [1, 1];
