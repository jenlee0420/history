  ...
  <div id="app">
    ...
    <div v-show="!load" id="main_container" :style="mainBoxStyle">
      <div class="title_bar purpleGradient" :style="{ height: titleH + 'px' }">
        <span>東晉時期北方人口南遷路線圖 (317-420 年)</span>
    ...
    <modal class="" :style="AppStyle" :dragable="!isApp" headTitle="問題" :hideFooter="true" v-if="popWindow" @cancel-event="
      ...
      <div slot="modalCont">
        <div>
          <div class="question">
            <div class="flex">
              <em class="mr5">1.</em><em> 根據地圖所示<span class="dot">，</span>東晉首都建康位於哪一州的範圍內？</em>
            </div>
            <div>
            ...
            <div class="question question3">
              <div class="flex">
                <em class="mr5">2.</em>
                <em>
                以下哪項關於漢人南遷的描述是<span class="underline">不正確</span>的？</em>
            </div>
            <div>
      ...
      >
        <div slot="modalCont">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21884160.002360303!2d85.75293325032051!3d39.3241495510557!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35b58c9b668dcd83%3A0x8ffbb60b79df1b06!2z5Lit5ZyL5rGf6JiH55yB5Y2X5Lqs5biC!5e0!3m2!1szh-TW!2shk!4v1591587434112!5m2!1szh-TW!2shk"
  ...
  export default {
    ...
    data() {
     ...
     zhouming:false,
        ...
        showWrong: 0,
        currAns: null,
        questionItem2: ["A. 南來漢人多停留於長江以北",
          "B. 漢人為逃避外族統治南來 ",
          "C. 不少南遷漢人以寧州<span class='dot'>、</span>揚州為目的地"
        ],
        rightans2: 0,
        showWrong2: 0,
        currAns2: null,
        ...
        list: [{
          ...
          {
            ico: require("../static/img/icon/border_037_icon.png"),
            text: "國界",
            show: false
          },
          {
            ico: require("../static/img/icon/border1_037_icon.png"),
            text: "州界",
            show: false
          },
          {
            ico: require("../static/img/icon/route_037_icon.png"),
            text: "漢人主要南遷路線",
            show: false
          },
{
            ico: require("../static/img/icon/wuhu_icon.png"),
            text: "五胡十六國領土",
            show: false
          },
{
            ico: require("../static/img/icon/dongjin_icon.png"),
            text: "東晉領土",
            show: false
          },
    ...
    methods: {
      ...
      showCanvas(index) {
        ...
        switch (index) {
          ...
          case 2:
            ...
            this.control.border1 = swip
            this.control.zhouming=swip
            break;
          case 3:  
          ...
          case 4:
            ...
            if(swip){
              this.showCityAni(this.canvasObj['wuhu'],swip)
            }else{
              clearInterval(this.canvasObj['wuhu'].timeout);
              this.canvasObj['wuhu'].style.visibility = "visible";
              this.canvasObj['wuhu'].ani = false;
            }
            break;
          case 5:
            if (swip && !this.noVoice) {
            ...
            if(swip){
            this.showCityAni(this.canvasObj['dongjin'],swip)
            }else{
              clearInterval(this.canvasObj['dongjin'].timeout);
              this.canvasObj['dongjin'].style.visibility = "visible";
              this.canvasObj['dongjin'].ani = false;
            }
            break;
          case 6:
            this.mapPop = swip;
      ...
      createMap() {
        ...
        this.m01.src = require("../static/img/vo/chist_s1_map_037_1.mp3");
        this.m02.src = require("../static/img/vo/chist_s1_map_037_2.mp3");
        this.m03.src = require("../static/img/vo/chist_s1_map_037_3.mp3");
        this.m04.src = require("../static/img/vo/chist_s1_map_037_4.mp3");
       ...
       Object.keys(this.canvasImagesObj).forEach((element,i) => {
        ...
        this.insterCanvas2(routeb, 'route1.png', () => {
          this.pathObject2 = {
          source: routeb,
          originX: 0,
          originY: 0,
        ...
        this.insterCanvas2(imageHorse, 'refugee1.png', () => {
          var translate = [
            [538, 107], [614, 381],[392, 673]           
          ];
          var scale = [1, 1, 1];
          var dur = [
            60, 40,40
