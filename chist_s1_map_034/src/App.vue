  ...
  <div id="app">
    ...
    <div v-show="!load" id="main_container" :style="mainBoxStyle">
      <div class="title_bar purpleGradient" :style="{ height: titleH + 'px' }">
        <span>西晉時期胡人內徙分佈圖 (265-316 年)</span>
    ...
    <modal class="" :style="AppStyle" :dragable="!isApp" headTitle="問題" :hideFooter="true" v-if="popWindow" @cancel-event="
      ...
      <div slot="modalCont">
        <div>
          <div class="question">
            <div class="flex">
              <em class="mr5">1.</em><em>根據地圖所示<span class="dot">，</span>哪一個強大的胡族居於洛陽以北？</em>
            </div>
            <div>
            ...
            <div class="question question2">
              <div class="flex">
                <em class="mr5">2.</em>
                <em>根據地圖<span class="dot">，</span>以下哪項關於鮮卑族的描述是<span class="underline">不正確</span>的？</em>
            </div>
            <div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        mapPop: false,
        list: [{
            ico: require("../static/img/icon/xianbei_icon.png"),
            text: "鮮卑",
            show: false
          },
          {
            ico: require("../static/img/icon/xiongnu_icon.png"),
            text: "匈奴",
            show: false
          },
          {
            ico: require("../static/img/icon/qiang_icon.png"),
            text: "羌",
            show: false
          },
          {
          ...
          {
            ico: require("../static/img/icon/jie_icon.png"),
            text: "羯",
            show: false
          },
          {
    ...
    methods: {
      ...
      createMap() {
        ...
        this.m01.src = require("../static/img/vo/chist_s1_map_034_1.mp3");
        this.m02.src = require("../static/img/vo/chist_s1_map_034_2.mp3");
        this.m03.src = require("../static/img/vo/chist_s1_map_034_3.mp3");
        this.m04.src = require("../static/img/vo/chist_s1_map_034_4.mp3");
        this.m05.src = require("../static/img/vo/chist_s1_map_034_5.mp3");
        this.m06.src = require("../static/img/vo/chist_s1_map_034_6.mp3");
        this.m07.src = require("../static/img/vo/chist_s1_map_034_7.mp3");
        ...
        this.insterCanvas(capital, 'capital.png', 'canvascapital', true)
