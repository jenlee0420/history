    ...
    $(window).load(function() {
        ...
        var canvas = createMap(arr_flag, 1).draggable({
            ...
            drag: function(e, ui) {
                ...
                var maxHeight = ui.helper.height() - canvasH;
                var maxWidth = ui.helper.width() - canvasW;
                ...
                $("#main_container").data("redBox").css({
                    "top": -newTop / ui.helper.height() * (canvasH / 3),
                    "left": -newLeft / ui.helper.width() * (canvasW / 3)
                })

                // $('#debug1').text(JSON.stringify([
                //     //$("#main_container").data("redBox").css('top'), 
                //     //$("#main_container").data("redBox").css('left'),
                //     canvasW,
                //     canvasH,
                //     ui.helper.width(),
                //     ui.helper.height(),
            ...
            pinchStatus: function(event, phase, direction, distance, duration, fingerCount, pinchZoom) {
                ...
                //$("#debug").text(JSON.stringify([curr_zoom, direction, distance, duration, fingerCount, pinchZoom]))
