const animate = {
  sharpCity(obj,bool){
    ...
    drawHousePromise(flag) {
        this.canvasAnimHorse = document.getElementById("canvasmonk2");
    ...
    drawHousePromise3(flag,scene) {
      let that = scene
      let canvasAnimHorse = document.getElementById("canvasmonk3");
      ...
      if (flag) {
          ...
          that.resetHorseObject(that.horseObject3)
      }
  },
    ...
    drawHousePromise1(flag,canvasId,x,y) {
      let canvasAnimHorse = document.getElementById(canvasId);
      let contextAnimHorse = canvasAnimHorse.getContext("2d");
